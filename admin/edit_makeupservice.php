...
if(isset($_POST['submit']))
{
  ...
  $eid=$_SESSION['edid'];
  $query=mysqli_query($con, "update  tblmakeupservices set ServiceName='$sername',Description='$description',Cost='$cost',Image='$image' where Id='$eid' ");
  if ($query) {
...
<form role="form" method="post">
  ...
  <?php
  $eid=$_POST['edit_id'];
  $ret=mysqli_query($con,"select * from  tblmakeupservices where Id='$eid'");
  $cnt=1;
