...
//if{
  if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "insert into tblskinservices(ID,Category,ServiceName,Description,Cost,Image) values(NULL,'$category','$sername','$description','$cost','$img')");
    
    if ($query) {
      echo "<script>alert('Service has been added.');</script>"; 
      echo "<script>window.location.href = 'add_skinservice.php'</script>";   
      $msg="";
    }
    else
    {
             ...
             <div class="col-md-6">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Add Skin Care Service</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
