                  ...
                  <div class="modal-dialog ">
                    <div class="modal-content">
                      ...
                      <div class="modal-body" id="info_update">
                       <?php @include("edit_hairservice.php");?>
                     </div>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <?php
                    $ret=mysqli_query($con,"select *from  tblhairservices");
                    $cnt=1;
                    $path="../images/";
                    ...
                    while ($row=mysqli_fetch_array($ret)) {
                      ...
                      <tr>
                        ...
                        <td>
                         ...
                         <a href="dlt_hairservice.php?delete_id=<?php echo $row['Id'];?>"  class=" edit_data" id="<?php echo  $row['Id']; ?>" title="click for edit">Dlt</i></a>
                        </td>
                      </tr>   
                      <?php 
                      $cnt=$cnt+1;
