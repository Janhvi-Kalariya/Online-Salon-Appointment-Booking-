...
//if{
  if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "insert into tblmakeupservices(Id,Category,ServiceName,Description,Cost,Image) values(NULL,'$category','$sername','$description','$cost','$img')");
    if ($query) {
      echo "<script>alert('Service has been added.');</script>"; 
      echo "<script>window.location.href = 'add_makeupservice.php'</script>";   
      $msg="";
    }
    else
    {
             ...
             <div class="col-md-6">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Add Makeup Service</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                  ...
                  <div class="card-body">
                   <div class="form-group">
                      ...
                      <select name="category" class="form-select" aria-label="Default select example">
                        ...
                        <option value="Regular Makeup">Regular Makeup</option>
                        <option value="Bridal Makeup">Bridal Makeup</option>
                        <option value="Quirky Makeup">Quirky Makeup</option>
                      </select>
                    </div>
                    <div class="form-group">
