...
if(isset($_POST['submit']))
{
  ...
  $eid=$_SESSION['edid'];
  $query=mysqli_query($con, "update  tblskinservices set ServiceName='$sername',Description='$description',Cost='$cost',Image='$image' where Id='$eid' ");
  if ($query) {
...
<form role="form" method="post">
  ...
  <?php
  $eid=$_POST['edit_id'];
  $ret=mysqli_query($con,"select * from  tblskinservices where Id='$eid'");
  $cnt=1;
